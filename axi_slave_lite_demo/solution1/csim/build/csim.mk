...
HLS_SOURCES = ../../../../test.cpp ../../../../axi_slave_lite_reg.cpp
...
$(ObjDir)/axi_slave_lite_reg.o: ../../../../axi_slave_lite_reg.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../axi_slave_lite_reg.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/axi_slave_lite_reg.d
