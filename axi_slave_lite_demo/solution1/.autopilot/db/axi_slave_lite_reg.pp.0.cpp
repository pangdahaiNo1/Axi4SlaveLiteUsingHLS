...
# 2 "<built-in>" 2
# 1 "axi_slave_lite_reg.cpp" 2
# 1 "./axi_slave_lite_reg.hpp" 1
...
__attribute__((sdx_kernel("axi_slave_lite_reg", 0))) void axi_slave_lite_reg(
  AxiArPkt &s_ar,
  AxiAwPkt &s_aw,
  AxiBPkt &s_b,
  AxiRPkt &s_r,
...
# 2 "axi_slave_lite_reg.cpp" 2

static ap_uint<64> inner_reg_mini = 0x123;
...
#pragma HLS TOP name=axi_slave_lite_reg
# 17 "axi_slave_lite_reg.cpp"
...
#pragma HLS LATENCY max=0
 ...
 case 1:
  if(s_axi_w.wvalid){
   ...
   s_axi_b.bvalid = 0;
   s_axi_b.bresp = 0;
   wdata = s_axi_w.wdata & s_axi_w.wstrb;
   switch(waddr(4,3)){
    case 0:
     inner_reg0 = wdata;
     break;
